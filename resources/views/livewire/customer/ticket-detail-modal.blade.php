<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" wire:click.self="close">
    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col mx-4">
        {{-- Header --}}
                        ...
                        <div wire:key="message-{{ $message->id }}" class="flex gap-3 {{ $message->isFromAdmin() ? 'flex-row' : 'flex-row-reverse' }}">
                            ...
                            <div class="flex-shrink-0">
                                <div class="size-10 rounded-full {{ $message->isFromAdmin() ? 'bg-blue-100 dark:bg-blue-900' : 'bg-zinc-200 dark:bg-zinc-700' }} flex items-center justify-center">
                                    <flux:icon :name="$message->isFromAdmin() ? 'user-circle' : 'user'"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="{{ $message->isFromAdmin() ? 'bg-blue-50 dark:bg-blue-900/20 rounded-tl-none' : 'bg-zinc-100 dark:bg-zinc-800 rounded-tr-none' }} rounded-lg p-4">
